...
public class ChronicCare extends TransactionEntity implements Serializable {
    ...
    @Column(name = "date_completed_tb_treatment")
    private LocalDate dateCompletedTBTreatment;

    @Column(name = "tb_screening_status")
    private String tbScreeningStatus;

    @Column(name = "tb_date_sample_collected")
    private LocalDate tbDateSampleCollected;
    ...
    @EntityView(ChronicCare.class)
    public interface InitialChronicCareView {
